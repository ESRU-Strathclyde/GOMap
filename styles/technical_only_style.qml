...
<qgis simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyDrawingTol="1" minScale="100000000" version="3.12.3-București" simplifyDrawingHints="1" styleCategories="AllStyleCategories" maxScale="100000" labelsEnabled="0" simplifyLocal="1" readOnly="0">
  ...
  <renderer-v2 enableorderby="0" type="RuleRenderer" forceraster="0" symbollevels="0">
    <rules key="{12e28496-b9fa-4813-8238-ff51f38d197d}">
      <rule symbol="0" key="{5010aba9-1dc8-41aa-ada2-2e6c8f500168}" label="Favourable" filter="&quot;Technical_Category&quot; = 'Favourable'"/>
      <rule symbol="1" key="{447a744b-26e7-4a77-88aa-c8da98b81645}" label="Likely" filter="&quot;Technical_Category&quot; = 'Likely'"/>
      <rule symbol="2" key="{82f45f21-165d-4611-8c84-37da131ea76d}" label="Unlikely" filter="&quot;Technical_Category&quot; = 'Unlikely'"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="Technical_Category" index="1" name=""/>
  </aliases>
